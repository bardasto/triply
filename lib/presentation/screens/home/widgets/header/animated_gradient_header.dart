...
/// Animated gradient header with wavy bottom clipper.
class AnimatedGradientHeader extends StatelessWidget {
  final double opacity;

  const AnimatedGradientHeader({super.key, required this.opacity});
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: HomeTheme.gradientColors,
                stops: HomeTheme.gradientStops,
              ),
            ),
          ),
        ),
