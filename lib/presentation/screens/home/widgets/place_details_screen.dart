...
class _PlaceDetailsScreenState extends State<PlaceDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          CustomScrollView(
            // ✅ Добавлена физика BouncingScrollPhysics для эффекта как в Telegram/iOS
            physics: const BouncingScrollPhysics(),
            slivers: [
              SliverToBoxAdapter(
                // ✅ ИСПРАВЛЕНИЕ: ClipRRect теперь оборачивает весь контейнер изображения
                child: ClipRRect(
                  ...
                  child: SizedBox(
                    ...
                    height:
                        320 + safeTop, // Немного увеличил высоту для красоты
                    child: Stack(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if ((place['description'] as String).length >
                                  100) ...[
  ...
  // ... (Остальные методы без изменений: _buildUnifiedInfoBlock и ниже)
