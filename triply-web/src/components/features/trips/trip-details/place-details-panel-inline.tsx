...
import { Star, MapPin, Clock, ChevronDown, Navigation, Utensils, Building2, X } from "lucide-react";
...
interface PlaceDetailsPanelInlineProps {
  poi: POIMarker | null;
  placeData?: TripPlace | PublicTripPlace | null;
  onClose: () => void;
}

export function PlaceDetailsPanelInline({
  poi,
  placeData,
  onClose,
}: PlaceDetailsPanelInlineProps) {
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin">
        ...
        <div className="relative">
          <ImageSliderGallery
            ...
            badge={
              <div className={cn(
                "absolute top-3 left-3 flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium z-10",
                poi.type === "restaurant"
          ...
          <button
            onClick={onClose}
            className="absolute top-3 right-3 p-2 rounded-full bg-black/30 backdrop-blur-md hover:bg-black/50 transition-colors z-20"
          >
        ...
        <div className="space-y-1">
          ...
          <div className={cn(
            ...
            >
              ...
              <span className={cn("text-sm flex-1 text-left", hoursStatusColor)}>
                {hoursStatus}
              </span>
              {hasDetailedHours && (
                <ChevronDown
      ...
      <div className="p-4 border-t border-white/10 flex-shrink-0">
        <button
          onClick={openInMaps}
          className={cn(
            "w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-medium transition-colors",
            poi.type === "restaurant"
